...
namespace ProceduralWings
{
    public static class UIUtility
    {
        public static float FieldSlider (float value, float increment, float incrementLarge, Vector2 limits, string name, out bool changed, Color backgroundColor, int valueType, bool allowFine = true)
        {
            ...
            GUI.Label (rectSlider, "  " + name, ProceduralWingManager.uiStyleLabelHint);
            GUI.Label (rectLabelValue, GetValueTranslation (value, valueType), ProceduralWingManager.uiStyleLabelHint);
