...
namespace ProceduralWings
{
    class ControlProcedural : WingProcedural
    {
        ...
        public override Vector2 GetLimitsFromType(Vector4 set)
        {
        ...
        public override void OnWindow(int window)
        {
            if (uiEditMode)
            {
                ...
                {
                    DrawField(ref sharedEdgeTypeTrailing, sharedIncrementInt, sharedIncrementInt, GetLimitsFromType(sharedEdgeTypeLimits), "Shape", uiColorSliderEdgeT, 10, 3, false);
