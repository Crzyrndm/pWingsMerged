...
namespace ProceduralWings
{
    ...
    //        sharedEdgeTypeLeading = wing.sharedEdgeTypeLeading;
    //        sharedEdgeWidthLeadingRoot = wing.sharedEdgeWidthLeadingTip;
    //        sharedEdgeWidthLeadingTip = (float)Clamp(sharedEdgeWidthLeadingRoot + ((wing.sharedEdgeWidthLeadingTip - wing.sharedEdgeWidthLeadingRoot) / wing.sharedBaseLength) * sharedBaseLength, sharedEdgeWidthLimits.x, sharedEdgeWidthLimits.y);

    //        sharedEdgeTypeTrailing = wing.sharedEdgeTypeTrailing;
    //        sharedEdgeWidthTrailingRoot = wing.sharedEdgeWidthTrailingTip;
    //        sharedEdgeWidthTrailingTip = (float)Clamp(sharedEdgeWidthTrailingRoot + ((wing.sharedEdgeWidthTrailingTip - wing.sharedEdgeWidthTrailingRoot) / wing.sharedBaseLength) * sharedBaseLength, sharedEdgeWidthLimits.x, sharedEdgeWidthLimits.y);
    //    }
