...
namespace ProceduralWings
{
    public class WingProcedural // : ProceduralWing
    {
        ...
        //        {
        //            if (GUILayout.Button(ProceduralWingManager.wingTankConfigurations[fuelSelectedTankSetup].ConfigurationName + " | Next tank setup", ProceduralWingManager.uiStyleButton)) NextConfiguration();
        //        }
        ...
        //static KeyCode keyLeading = KeyCode.LeftAlt, keyTrailing = KeyCode.LeftControl;
