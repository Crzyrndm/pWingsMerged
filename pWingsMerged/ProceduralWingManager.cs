...
namespace ProceduralWings
{
    ...
    public class ProceduralWingManager : MonoBehaviour
    {
        ...
        {
            if (debugButtonStock != null)
                return;
            debugButtonStock = ApplicationLauncher.Instance.AddModApplication (OnAppLaunchToggleOn, OnAppLaunchToggleOff, null, null, null, null, ApplicationLauncher.AppScenes.SPACECENTER,
